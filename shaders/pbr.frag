...
{		
    ...
    float metallic  = texture(material.texture_metallicMap1, TexCoords).r;
    float roughness = texture(material.texture_roughnessMap1, TexCoords).r;
    float ao        = texture(material.texture_aoMap1, TexCoords).r;
